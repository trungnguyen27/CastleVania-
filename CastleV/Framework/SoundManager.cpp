...
void SoundManager::loadSound(HWND hWnd)
{
	...
	sound = LoadSound("Resources//Sounds//fishman_jump.wav");
	_listSound[FISHMAN_JUMP] = sound;

	sound = LoadSound("Resources//Sounds//fishman_fall.wav");
	_listSound[FISHMAN_FALL] = sound;

	sound = LoadSound("Resources//Sounds//hit_fishman.wav");
	_listSound[HIT_FISHMAN] = sound;

	sound = LoadSound("Resources//Sounds//throw_holywater.wav");
	_listSound[THROW_HOLYWATER] = sound;

	sound = LoadSound("Resources//Sounds//throw_molotov.wav");
	_listSound[THROW_MOLOTOV] = sound;
}
